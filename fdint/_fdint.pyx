...
cdef inline double fdm9h(double phi):
    if phi < -2e0:
        return fdm9h_lt_m2(phi)
    if phi < 0e0:
        return fdm9h_m2_to_0(phi)
    if phi < 2e0:
        return fdm9h_0_to_2(phi)
    if phi < 5e0:
        return fdm9h_2_to_5(phi)
    if phi < 10e0:
        return fdm9h_5_to_10(phi)
    if phi < 20e0:
        return fdm9h_10_to_20(phi)
    if phi < 40e0:
        return fdm9h_20_to_40(phi)
    return fdm9h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fdm7h(double phi):
    if phi < -2e0:
        return fdm7h_lt_m2(phi)
    if phi < 0e0:
        return fdm7h_m2_to_0(phi)
    if phi < 2e0:
        return fdm7h_0_to_2(phi)
    if phi < 5e0:
        return fdm7h_2_to_5(phi)
    if phi < 10e0:
        return fdm7h_5_to_10(phi)
    if phi < 20e0:
        return fdm7h_10_to_20(phi)
    if phi < 40e0:
        return fdm7h_20_to_40(phi)
    return fdm7h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fdm5h(double phi):
    if phi < -2e0:
        return fdm5h_lt_m2(phi)
    if phi < 0e0:
        return fdm5h_m2_to_0(phi)
    if phi < 2e0:
        return fdm5h_0_to_2(phi)
    if phi < 5e0:
        return fdm5h_2_to_5(phi)
    if phi < 10e0:
        return fdm5h_5_to_10(phi)
    if phi < 20e0:
        return fdm5h_10_to_20(phi)
    if phi < 40e0:
        return fdm5h_20_to_40(phi)
    return fdm5h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fdm3h(double phi):
    if phi < -2e0:
        return fdm3h_lt_m2(phi)
    if phi < 0e0:
        return fdm3h_m2_to_0(phi)
    if phi < 2e0:
        return fdm3h_0_to_2(phi)
    if phi < 5e0:
        return fdm3h_2_to_5(phi)
    if phi < 10e0:
        return fdm3h_5_to_10(phi)
    if phi < 20e0:
        return fdm3h_10_to_20(phi)
    if phi < 40e0:
        return fdm3h_20_to_40(phi)
    return fdm3h_gt_40(phi)
...
cdef inline double fd3h(double phi):
    if phi < -2e0:
        return fd3h_lt_m2(phi)
    if phi < 0e0:
        return fd3h_m2_to_0(phi)
    if phi < 2e0:
        return fd3h_0_to_2(phi)
    if phi < 5e0:
        return fd3h_2_to_5(phi)
    if phi < 10e0:
        return fd3h_5_to_10(phi)
    if phi < 20e0:
        return fd3h_10_to_20(phi)
    if phi < 40e0:
        return fd3h_20_to_40(phi)
    return fd3h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd5h(double phi):
    if phi < -2e0:
        return fd5h_lt_m2(phi)
    if phi < 0e0:
        return fd5h_m2_to_0(phi)
    if phi < 2e0:
        return fd5h_0_to_2(phi)
    if phi < 5e0:
        return fd5h_2_to_5(phi)
    if phi < 10e0:
        return fd5h_5_to_10(phi)
    if phi < 20e0:
        return fd5h_10_to_20(phi)
    if phi < 40e0:
        return fd5h_20_to_40(phi)
    return fd5h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd7h(double phi):
    if phi < -2e0:
        return fd7h_lt_m2(phi)
    if phi < 0e0:
        return fd7h_m2_to_0(phi)
    if phi < 2e0:
        return fd7h_0_to_2(phi)
    if phi < 5e0:
        return fd7h_2_to_5(phi)
    if phi < 10e0:
        return fd7h_5_to_10(phi)
    if phi < 20e0:
        return fd7h_10_to_20(phi)
    if phi < 40e0:
        return fd7h_20_to_40(phi)
    return fd7h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd9h(double phi):
    if phi < -2e0:
        return fd9h_lt_m2(phi)
    if phi < 0e0:
        return fd9h_m2_to_0(phi)
    if phi < 2e0:
        return fd9h_0_to_2(phi)
    if phi < 5e0:
        return fd9h_2_to_5(phi)
    if phi < 10e0:
        return fd9h_5_to_10(phi)
    if phi < 20e0:
        return fd9h_10_to_20(phi)
    if phi < 40e0:
        return fd9h_20_to_40(phi)
    return fd9h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd11h(double phi):
    if phi < -2e0:
        return fd11h_lt_m2(phi)
    if phi < 0e0:
        return fd11h_m2_to_0(phi)
    if phi < 2e0:
        return fd11h_0_to_2(phi)
    if phi < 5e0:
        return fd11h_2_to_5(phi)
    if phi < 10e0:
        return fd11h_5_to_10(phi)
    if phi < 20e0:
        return fd11h_10_to_20(phi)
    if phi < 40e0:
        return fd11h_20_to_40(phi)
    return fd11h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd13h(double phi):
    if phi < -2e0:
        return fd13h_lt_m2(phi)
    if phi < 0e0:
        return fd13h_m2_to_0(phi)
    if phi < 2e0:
        return fd13h_0_to_2(phi)
    if phi < 5e0:
        return fd13h_2_to_5(phi)
    if phi < 10e0:
        return fd13h_5_to_10(phi)
    if phi < 20e0:
        return fd13h_10_to_20(phi)
    if phi < 40e0:
        return fd13h_20_to_40(phi)
    return fd13h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd15h(double phi):
    if phi < -2e0:
        return fd15h_lt_m2(phi)
    if phi < 0e0:
        return fd15h_m2_to_0(phi)
    if phi < 2e0:
        return fd15h_0_to_2(phi)
    if phi < 5e0:
        return fd15h_2_to_5(phi)
    if phi < 10e0:
        return fd15h_5_to_10(phi)
    if phi < 20e0:
        return fd15h_10_to_20(phi)
    if phi < 40e0:
        return fd15h_20_to_40(phi)
    return fd15h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd17h(double phi):
    if phi < -2e0:
        return fd17h_lt_m2(phi)
    if phi < 0e0:
        return fd17h_m2_to_0(phi)
    if phi < 2e0:
        return fd17h_0_to_2(phi)
    if phi < 5e0:
        return fd17h_2_to_5(phi)
    if phi < 10e0:
        return fd17h_5_to_10(phi)
    if phi < 20e0:
        return fd17h_10_to_20(phi)
    if phi < 40e0:
        return fd17h_20_to_40(phi)
    return fd17h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd19h(double phi):
    if phi < -2e0:
        return fd19h_lt_m2(phi)
    if phi < 0e0:
        return fd19h_m2_to_0(phi)
    if phi < 2e0:
        return fd19h_0_to_2(phi)
    if phi < 5e0:
        return fd19h_2_to_5(phi)
    if phi < 10e0:
        return fd19h_5_to_10(phi)
    if phi < 20e0:
        return fd19h_10_to_20(phi)
    if phi < 40e0:
        return fd19h_20_to_40(phi)
    return fd19h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fd21h(double phi):
    if phi < -2e0:
        return fd21h_lt_m2(phi)
    if phi < 0e0:
        return fd21h_m2_to_0(phi)
    if phi < 2e0:
        return fd21h_0_to_2(phi)
    if phi < 5e0:
        return fd21h_2_to_5(phi)
    if phi < 10e0:
        return fd21h_5_to_10(phi)
    if phi < 20e0:
        return fd21h_10_to_20(phi)
    if phi < 40e0:
        return fd21h_20_to_40(phi)
    return fd21h_gt_40(phi)

@cython.cdivision(True)
cdef inline double fdm9h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(0.270088205852269109e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    return (-1.8432713155273516e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return (27.9376225634323064e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return -(0.105736863491337914e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return -(0.0131615741211877996e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return -(0.000243271785585373458e0 \
...
@cython.cdivision(True)
cdef inline double fdm9h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return -(5.76414987722574846e-6 \
...
@cython.cdivision(True)
cdef inline double fdm9h_gt_40(double phi):
    cdef double factor = -2e0/7e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
    return factor/(sqrt(phi)*phi*phi*phi)*(1e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(-0.945308720482941881e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    return (5.49736264373955718e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return (143.837264704139569e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return -(66.1873851488861175e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return -(0.184179377827614791e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return -(0.00521027824483942692e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return -(0.000222755850099679261e0 \
...
@cython.cdivision(True)
cdef inline double fdm7h_gt_40(double phi):
    cdef double factor = -2e0/5e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
    return factor/(sqrt(phi)*phi*phi)*(1e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(2.36327180120735470e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    return (46.7273884990861909e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return -(55.096201117757232e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return -(4.91753613607304828e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return -(2.27928384600199307e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return -(0.138865047109769882e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return -(0.294313222065093082e0 \
...
@cython.cdivision(True)
cdef inline double fdm5h_gt_40(double phi):
    cdef double factor = -2e0/3e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
    return factor/(sqrt(phi)*phi)*(1e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(-3.54490770181103205e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return -(946.638483706348559e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return -(754.61690882095729e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return -(526.022770226139287e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return -(18.0110784494455205e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return -(4.10698092142661427e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return -(95.2141371910496454e0 \
...
@cython.cdivision(True)
cdef inline double fdm3h_gt_40(double phi):
    cdef double factor = -2e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
    return factor/sqrt(phi)*(1e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(1.77245385090551603e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (272.770092131932696e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return (3531.50360568243046e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (4060.70753404118265e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (1198.41719029557508e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (9446.00169435237637e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (22977.9657855367223e0 \
...
@cython.cdivision(True)
cdef inline double fdm1h_gt_40(double phi):
    cdef double factor = 2e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd1h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
...
@cython.cdivision(True)
cdef inline double fd1h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
...
@cython.cdivision(True)
cdef inline double fd1h_0_to_2(double phi):
    cdef double t=0.5e0*phi
...
@cython.cdivision(True)
cdef inline double fd1h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
...
@cython.cdivision(True)
cdef inline double fd1h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
...
@cython.cdivision(True)
cdef inline double fd1h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
...
@cython.cdivision(True)
cdef inline double fd1h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
...
@cython.cdivision(True)
cdef inline double fd1h_gt_40(double phi):
    cdef double factor = 2e0/3e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
...
@cython.cdivision(True)
cdef inline double fd3h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(1.32934038817913702e0 \
...
@cython.cdivision(True)
cdef inline double fd3h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (631.667081787115831e0 \
...
@cython.cdivision(True)
cdef inline double fd3h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    return (90122.488639370400e0 \
...
@cython.cdivision(True)
cdef inline double fd3h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (912944.432058014054e0 \
...
@cython.cdivision(True)
cdef inline double fd3h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (1.88412548327216052e6 \
...
@cython.cdivision(True)
cdef inline double fd3h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (1.59656593348660977e9 \
...
@cython.cdivision(True)
cdef inline double fd3h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (2.60437581212904589e8 \
...
@cython.cdivision(True)
cdef inline double fd3h_gt_40(double phi):
    cdef double factor = 2e0/5e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double s=1e0-1600e0*w
    return phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd5h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(3.32335097044784255e0 \
...
@cython.cdivision(True)
cdef inline double fd5h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (3273.17630052701392e0 \
...
@cython.cdivision(True)
cdef inline double fd5h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (46746.0667679244140e0 \
...
@cython.cdivision(True)
cdef inline double fd5h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (2.96446396463084245e6 \
...
@cython.cdivision(True)
cdef inline double fd5h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (5.98759698946959779e7 \
...
@cython.cdivision(True)
cdef inline double fd5h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (1.11471644837527339e9 \
...
@cython.cdivision(True)
cdef inline double fd5h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (8.02670881104191218e9 \
...
@cython.cdivision(True)
cdef inline double fd5h_gt_40(double phi):
    cdef double factor = 2e0/7e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd7h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(11.6317283965674489e0 \
...
@cython.cdivision(True)
cdef inline double fd7h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (12412.9547163940264e0 \
...
@cython.cdivision(True)
cdef inline double fd7h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (138724.961458493789e0 \
...
@cython.cdivision(True)
cdef inline double fd7h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (2.20638302461716245e7 \
...
@cython.cdivision(True)
cdef inline double fd7h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (3.0709767203984838e9 \
...
@cython.cdivision(True)
cdef inline double fd7h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (4.91615192873221833e9 \
...
@cython.cdivision(True)
cdef inline double fd7h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (1.23356074447405045e12 \
...
@cython.cdivision(True)
cdef inline double fd7h_gt_40(double phi):
    cdef double factor = 2e0/9e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd9h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(52.3427777845535202e0 \
...
@cython.cdivision(True)
cdef inline double fd9h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (69576.0137991453185e0 \
...
@cython.cdivision(True)
cdef inline double fd9h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (514822.53904173208e0 \
...
@cython.cdivision(True)
cdef inline double fd9h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (3.42730803487596668e7 \
...
@cython.cdivision(True)
cdef inline double fd9h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (4.89775289337907328e9 \
...
@cython.cdivision(True)
cdef inline double fd9h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (2.2676209606423816e13 \
...
@cython.cdivision(True)
cdef inline double fd9h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (1.65627579413599954e13 \
...
@cython.cdivision(True)
cdef inline double fd9h_gt_40(double phi):
    cdef double factor = 2e0/11e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd11h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(287.885277815044361e0 \
...
@cython.cdivision(True)
cdef inline double fd11h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (399729.728975269086e0 \
...
@cython.cdivision(True)
cdef inline double fd11h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (2.40644550206125935e6 \
...
@cython.cdivision(True)
cdef inline double fd11h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    return (7.70852968624936390e8 \
...
@cython.cdivision(True)
cdef inline double fd11h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (1.71681959469725307e10 \
...
@cython.cdivision(True)
cdef inline double fd11h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (1.05700178515928121e12 \
...
@cython.cdivision(True)
cdef inline double fd11h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (1.06038260567473087e14 \
...
@cython.cdivision(True)
cdef inline double fd11h_gt_40(double phi):
    cdef double factor = 2e0/13e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd13h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    cdef double s=1e0-t
    return exp_phi*(1871.25430579778835e0 \
...
@cython.cdivision(True)
cdef inline double fd13h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (2.94504307654357499e6 \
...
@cython.cdivision(True)
cdef inline double fd13h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (1.45543624525939873e7 \
...
@cython.cdivision(True)
cdef inline double fd13h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    cdef double s=1e0-t
    return (1.93509493140212933e9 \
...
@cython.cdivision(True)
cdef inline double fd13h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    return (5.2085062280477356e11 \
...
@cython.cdivision(True)
cdef inline double fd13h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    return (7.7494086475291441e13 \
...
@cython.cdivision(True)
cdef inline double fd13h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    return (1.22298919425291664e16 \
...
@cython.cdivision(True)
cdef inline double fd13h_gt_40(double phi):
    cdef double factor = 2e0/15e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd15h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    return exp_phi*(14034.4072934834126e0 \
...
@cython.cdivision(True)
cdef inline double fd15h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (2.06790092766575034e7 \
...
@cython.cdivision(True)
cdef inline double fd15h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (1.14403769376860621e8 \
...
@cython.cdivision(True)
cdef inline double fd15h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    cdef double s=1e0-t
    return (6.26769725573910255e9 \
...
@cython.cdivision(True)
cdef inline double fd15h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    cdef double s=1e0-t
    return (5.69341524462926732e11 \
...
@cython.cdivision(True)
cdef inline double fd15h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    cdef double s=1e0-t
    return (6.79824678667324436e13 \
...
@cython.cdivision(True)
cdef inline double fd15h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    cdef double s=1e0-t
    return (1.99221037305471970e16 \
...
@cython.cdivision(True)
cdef inline double fd15h_gt_40(double phi):
    cdef double factor = 2e0/17e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd17h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    cdef double s=1e0-t
    return exp_phi*(119292.461994609007e0 \
...
@cython.cdivision(True)
cdef inline double fd17h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (1.43233835112073902e8 \
...
@cython.cdivision(True)
cdef inline double fd17h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (1.21473360069923149e9 \
...
@cython.cdivision(True)
cdef inline double fd17h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    cdef double s=1e0-t
    return (2.67440099736518804e10 \
...
@cython.cdivision(True)
cdef inline double fd17h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    cdef double s=1e0-t
    return (1.21689593180741239e12 \
...
@cython.cdivision(True)
cdef inline double fd17h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    cdef double s=1e0-t
    return (8.36136698862497927e13 \
...
@cython.cdivision(True)
cdef inline double fd17h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    cdef double s=1e0-t
    return (2.85846778936881832e16 \
...
@cython.cdivision(True)
cdef inline double fd17h_gt_40(double phi):
    cdef double factor = 2e0/19e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd19h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    cdef double s=1e0-t
    return exp_phi*(1.13327838894878557e6 \
...
@cython.cdivision(True)
cdef inline double fd19h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (1.98943681340803829e9 \
...
@cython.cdivision(True)
cdef inline double fd19h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (2.0904667585793652e10 \
...
@cython.cdivision(True)
cdef inline double fd19h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    cdef double s=1e0-t
    return (1.46863114809614622e11 \
...
@cython.cdivision(True)
cdef inline double fd19h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    cdef double s=1e0-t
    return (4.12413857105017004e12 \
...
@cython.cdivision(True)
cdef inline double fd19h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    cdef double s=1e0-t
    return (4.83390017425457148e15 \
...
@cython.cdivision(True)
cdef inline double fd19h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    cdef double s=1e0-t
    return (2.81147322924282096e18 \
...
@cython.cdivision(True)
cdef inline double fd19h_gt_40(double phi):
    cdef double factor = 2e0/21e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
...
@cython.cdivision(True)
cdef inline double fd21h_lt_m2(double phi):
    cdef double exp_phi=exp(phi)
    cdef double t=exp_phi*7.38905609893065023e0
    cdef double s=1e0-t
    return exp_phi*(1.18994230839622485e7 \
...
@cython.cdivision(True)
cdef inline double fd21h_m2_to_0(double phi):
    cdef double s=-0.5e0*phi
    cdef double t=1e0-s
    return (2.57000236613575175e10 \
...
@cython.cdivision(True)
cdef inline double fd21h_0_to_2(double phi):
    cdef double t=0.5e0*phi
    cdef double s=1e0-t
    return (3.9256463321926022e11 \
...
@cython.cdivision(True)
cdef inline double fd21h_2_to_5(double phi):
    cdef double t=0.3333333333333333333e0*(phi-2e0)
    cdef double s=1e0-t
    return (1.02038438555518024e12 \
...
@cython.cdivision(True)
cdef inline double fd21h_5_to_10(double phi):
    cdef double t=0.2e0*phi-1e0
    cdef double s=1e0-t
    return (1.92539440493876721e13 \
...
@cython.cdivision(True)
cdef inline double fd21h_10_to_20(double phi):
    cdef double t=0.1e0*phi-1e0
    cdef double s=1e0-t
    return (1.35032839928658828e16 \
...
@cython.cdivision(True)
cdef inline double fd21h_20_to_40(double phi):
    cdef double t=0.05e0*phi-1e0
    cdef double s=1e0-t
    return (1.01458237235662575e19 \
...
@cython.cdivision(True)
cdef inline double fd21h_gt_40(double phi):
    cdef double factor = 2e0/23e0   # = 1/(k+1)
    cdef double w=1e0/(phi*phi)
    cdef double t=1600e0*w
    return phi*phi*phi*phi*phi*phi*phi*phi*phi*phi*phi*sqrt(phi)*factor*(1e0 \
