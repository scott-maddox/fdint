...
with open(fpath, 'w') as f:
    for i in xrange(-1,6,2):
        k2 = str(i).replace('-','m')
        f.write('cdef double gfd{k2}h(double phi, double beta)\n'.format(k2=k2))
        for ext in ['lt_m2', 'm2_to_0', '0_to_2', '2_to_5', '5_to_10',
                  '10_to_20', '20_to_40', 'gt_40']:
            f.write('cdef double gfd{k2}h_{ext}(double phi, double beta)\n'
    ...
    for i in xrange(-1,6,2):
        ...
        for ext in ['lt_m2', 'm2_to_0', '0_to_2', '2_to_5', '5_to_10',
            ...
            for m, _ in enumerate(xrange(i, 22, 2)):
                ...
                if m > 10:
                    break
                f.write('cdef double gfd{k2}h_{ext}__{m}(double phi, double beta)\n'
